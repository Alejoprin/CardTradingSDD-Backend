...
public interface CustomCardRepository extends JpaRepository<CustomCard, UUID> {
    ...
    Optional<CustomCard> findByOwnerIdAndNameAndRarityAndSetIsNull(UUID ownerId, String name, Card.Rarity rarity);
    Optional<CustomCard> findByOwnerIdAndNameAndRarityAndSetId(UUID ownerId, String name, Card.Rarity rarity, UUID setId);
}
